...
class RawNet(nn.Module):
    def __init__(self, d_args, device):
        ...
        self.block3 = nn.Sequential(Residual_block(nb_filts = [512, 512]))
        self.block4 = nn.Sequential(Residual_block(nb_filts = [512, 512]))
        self.block5 = nn.Sequential(Residual_block(nb_filts = [512, 512]))
